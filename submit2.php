...
<body>
  <center>
<button type="submit" name="generate" onclick="window.print()">
...
<div class="grid-container">
  ...
  <div class="zone-2">
    <div class="headTitle">
      <h1 class="namehead"><b><?php echo ucwords($first_name);?>&nbsp;<?php echo ucwords($last_name);?></b></h1>
    </div>
    <div class="subTitle">
...
include("db.php");
    ...
    if(isset($_POST['generate'])){
        ...
        $degree1    = $_POST['degree1'];
            ...
            $query = "INSERT INTO personal (first_name,last_name,email,phone,degree1) values('$first_name','$last_name','$email','$phone','$degree1')";

            $data = mysqli_query($con,$query);
    
            if($data){
             echo "<script>alert('CV Generated Succesfully..')</script>";
            }
            else{
                echo "Failed";
            }
