        ...
        <form action="submit2.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="border border-dark p-3 mb-3">    
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="profession" required autocomplete="off">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="tel" class="form-control" id="phone" name="phone" placeholder="9678543210" required autocomplete="off">
                </div>
            </div>
            <div class="border border-dark p-3 mb-3">    
                <h2>Skills (Max:5)</h2>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="skill1" required autocomplete="off">
            ...
            <div class="border border-dark p-3 mb-3">    
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="hobby1" class="form-control" required autocomplete="off">
                </div>
                <div id="addHobby"></div>
                <div class="mb-3">
            ...
            <div class="border border-dark p-3 mb-3">    
                ...
                <div class="form-floating">
                    <textarea class="form-control" name="about_me" style="height: 100px" required autocomplete="off"></textarea>
                </div>
            </div>
            <div class="border border-dark p-3 mb-3">    
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="institute1" class="form-control" autocomplete="off">
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Degree Name</label>
                    <input type="text" name="degree1" class="form-control" autocomplete="off">
                </div>
                <div class="mb-3 d-flex justify-content-between">
                    <div>
                        <label for="exampleInputEmail1" class="form-label">From</label>
                        <input type="text" name="from1" class="form-control" autocomplete="off">
                    </div>
                    <div>
                        <label for="exampleInputEmail1" class="form-label">To</label>
                        <input type="text" name="to1" class="form-control" autocomplete="off">
                    </div>
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Grade/Score/CGPA</label>
                    <input type="text" name="grade1" class="form-control" autocomplete="off">
                </div>
            ...
            <div class="border border-dark p-3 mb-3">    
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="title1" class="form-control" autocomplete="off">
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Description</label>
                    <input type="text" name="description1" class="form-control" autocomplete="off">
                </div>
            ...
            <button type="submit" class="form-control my-2" name="generate">Generate CV</button>
